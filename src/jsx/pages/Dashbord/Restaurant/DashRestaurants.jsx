...
export default function RestoDb() {
  const { restaurants, fetchRestaurants, purchaseOrders, purchaseOrderFile, generatePurchaseOrder, clearPurchaseOrders } = useRestaurantStore();
  ...
  const [selectedRestaurantName, setSelectedRestaurantName] = React.useState("");
      ...
      <div className="card">
        <div className="card-header d-flex justify-content-between">
          <Row className="w-100 align-items-center justify-content-between">
            ...
            <Col xs={12} md={4} className="d-flex justify-content-md-end mb-2 mb-md-0">
              <Row className="w-100">
                <Col xs={6} md={6}>
                  <Button
                    variant="info"
        ...
        <div className="card-body">
          {error && (
            <div className="alert alert-danger rounded" role="alert" style={{ padding: "10px" }}>
              {error}
            </div>
          )}
          <GlobalFilter
