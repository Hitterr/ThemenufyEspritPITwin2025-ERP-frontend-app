  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: error.message || "We couldn't recognize your face. Please try again or use another login method.",
      });
    } finally {
      setIsLoading(false);
    }
    ...
    >
      ...
      <Modal.Footer className="border-0 pt-0 justify-content-center">
        <p className="text-muted mb-0">
          <Button variant="link" onClick={handleClose} className="text-decoration-none p-0">
